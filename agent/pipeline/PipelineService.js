...
const ToolPipeline_1 = require("./ToolPipeline");
const events_1 = require("events");
class PipelineService extends events_1.EventEmitter {
    constructor(executive, modelRouter, config = {}) {
        ...
        this.pipeline = new ToolPipeline_1.ToolPipeline(executive, modelRouter, {
     ...
     */
    async submitRequest(request, context = {}, options = {}) {
    ...
    async executeRequest(request) {
        ...
        const executionPromise = this.pipeline.execute(request.request, request.context, {
            autoPlanning: true,
