...
class ReasoningEngine {
    constructor(modelRouter, config, executive) {
        ...
        if (executive) {
            this.pipelineService = new PipelineService_1.PipelineService(executive, modelRouter, {
    ...
    async reason(systemPrompt, userPrompt, context, civilMode = false) {
        var _a;
        const mode = (context === null || context === void 0 ? void 0 : context.mode) || this.config.strategy || 'react';
        const persona = (context === null || context === void 0 ? void 0 : context.persona) || 'default';
        ...
        const needsTools = this.requiresToolUse(userPrompt, (context === null || context === void 0 ? void 0 : context.availableTools) || []);
        if (needsTools && ((_a = context === null || context === void 0 ? void 0 : context.availableTools) === null || _a === void 0 ? void 0 : _a.length)) {
...
Every answer should make the user think differently.`;
    ...
    async processReAct(systemPrompt, userPrompt, context) {
        ...
        const response = await this.modelRouter.route(`${systemPrompt}\n\nUser: ${userPrompt}`, {
            ...
            ...context === null || context === void 0 ? void 0 : context.constraints
        });
        return {
    ...
    async processToolUse(systemPrompt, userPrompt, mode, context) {
        ...
        try {
            ...
            const result = await this.pipelineService.submitRequest(userPrompt, {
                sessionId: (context === null || context === void 0 ? void 0 : context.sessionId) || 'reasoning_session',
                traceId: traceId,
                ...
                workingDir: (context === null || context === void 0 ? void 0 : context.workingDir) || process.cwd()
            }, {
                priority: 'high',
                config: {
            ...
            return {
                type: 'tool_use',
                content: ((_a = result.finalOutput) === null || _a === void 0 ? void 0 : _a.summary) || 'Tool execution completed',
    ...
    extractConstraints(context) {
        const constraints = [];
        if (context === null || context === void 0 ? void 0 : context.allowUnsafeTools) {
            constraints.push('allow_unsafe_tools');
        }
        if (context === null || context === void 0 ? void 0 : context.allowCodeExecution) {
    ...
    getPipelineMetrics() {
        var _a;
        return ((_a = this.pipelineService) === null || _a === void 0 ? void 0 : _a.getMetrics()) || null;
    }
    /**
    ...
    getPipelineQueueStatus() {
        var _a;
        return ((_a = this.pipelineService) === null || _a === void 0 ? void 0 : _a.getQueueStatus()) || null;
    }
    /**
