...
export declare class ReasoningEngine {
    ...
    reason(systemPrompt: string, userPrompt: string, context?: {
        sessionHistory?: any[];
        availableTools?: string[];
        constraints?: Record<string, any>;
        mode?: ReasoningMode;
        persona?: string;
    }, civilMode?: boolean): Promise<ReasoningResult>;
     ...
     */
    getPipelineMetrics(): import("../pipeline/PipelineService").PipelineMetrics | null;
    /**
