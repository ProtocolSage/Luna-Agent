  ...
  useEffect(() => {
    const initializeVoiceSystem = async () => {
      try {
        ...
        console.log(
          "[VoiceIntegration] Enhanced voice system initialized successfully",
        );
...
• PTT Key: ${voiceConfig.pttKey}
        ...
        console.error(
          "[VoiceIntegration] Failed to initialize voice system:",
          error,
        );
        onError?.(
          `Voice system initialization failed: ${error instanceof Error ? error.message : String(error)}`,
        );
      }
    };
