import { LLMResponse, ModelConfig, CircuitBreakerState, ModelMetrics } from '../../types';
export declare class ModelRouter {
    ...
    private callMistral;
    calculateOpenAICost(modelName: string, usage: {
     ...
     */
    routeWithOfflineFallback(prompt: string, options?: {
        temperature?: number;
        maxTokens?: number;
        preferredModel?: string;
        timeout?: number;
