...
const { VoiceInputService } = require('./dist/backend/services/VoiceInputService.js');
...
async function testVoiceInputService() {
  ...
  try {
    ...
    console.log('⚠️  Start listening error (expected without OpenAI key):', error.message);
  }
