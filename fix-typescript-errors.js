...
const luxuryAppPath = path.join(
  __dirname,
  "app/renderer/components/LuxuryApp.tsx",
);
...
const wakeWordPath = path.join(
  __dirname,
  "app/renderer/services/WakeWordListener.ts",
);
