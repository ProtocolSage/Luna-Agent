  ...
  registerAll() {
    ...
    this.registerTool({
      ...
      handler: async (args) => {
        ...
        return (0, child_process_1.execSync)(args.command, {
    ...
    this.registerTool({
      ...
      handler: async (args, ctx) => {
        ...
        try {
          return (0, child_process_1.execSync)(`python "${fname}"`, {
            encoding: "utf8",
            timeout: 30000,
          });
        } finally {
    ...
    this.registerTool({
      ...
      handler: async (args, ctx) => {
        ...
        await fs.writeFile(fname, args.code, "utf8");
        try {
          return (0, child_process_1.execSync)(`node "${fname}"`, {
            encoding: "utf8",
            timeout: 30000,
          });
        } finally {
    ...
    this.registerTool({
      ...
      handler: async (args) => {
        ...
        try {
          const res = await (0, node_fetch_1.default)(args.url, {
    ...
    this.registerTool({
      ...
      handler: async (args) => {
        ...
        try {
          const html = await (
            await (0, node_fetch_1.default)(args.url, {
              signal: controller.signal,
            })
          ).text();
    ...
    this.registerTool({
      ...
      handler: async () => {
        if (process.platform === "win32")
          return (0, child_process_1.execSync)("powershell Get-Clipboard", {
            encoding: "utf8",
          });
        if (process.platform === "darwin")
          return (0, child_process_1.execSync)("pbpaste", { encoding: "utf8" });
        return (0, child_process_1.execSync)("xclip -selection clipboard -o", {
          encoding: "utf8",
        });
      },
    });
      ...
      handler: async (args) => {
        if (process.platform === "win32")
          (0, child_process_1.execSync)(
            `echo "${args.content.replace(/"/g, '\\"')}" | clip`,
          );
        else if (process.platform === "darwin")
          (0, child_process_1.execSync)(
            `echo "${args.content.replace(/"/g, '\\"')}" | pbcopy`,
          );
        else
          (0, child_process_1.execSync)(
    ...
    this.registerTool({
      ...
      handler: async () => {
        if (process.platform === "win32") {
          const out = (0, child_process_1.execSync)(
