...
export class StreamingVoiceService extends EventEmitter {
  ...
  public async initialize(): Promise<void> {
    try {
      ...
      this.emit('error', error instanceof Error ? error.message : 'Initialization failed');
      throw error;
    }
  }
  ...
  private async attemptReconnect(): Promise<void> {
    ...
    console.log(`[StreamingVoiceClient] Reconnection attempt ${this.reconnectAttempts}/${this.maxReconnectAttempts}`);
  ...
  private async initializeAudio(): Promise<void> {
    try {
      ...
      console.error('[StreamingVoiceClient] Failed to initialize audio:', error);
      throw error;
    }
  }
  ...
  private sendMessage(message: any): void {
    if (this.ws && this.isConnected && this.ws.readyState === WebSocket.OPEN) {
      ...
      console.warn('[StreamingVoiceClient] Cannot send message - not connected');
    }
  }
