...
describe('PlanParser Security', () => {
  ...
  describe('JSON Extraction', () => {
    ...
    it('should extract JSON from plain text response', () => {
      const text = 'Here is the plan: {"steps": [], "reasoning": "test", "confidence": 0.8, "dependencies": [], "estimatedTimeMs": 1000}';
  ...
  describe('JSON Repair', () => {
    it('should repair trailing commas', () => {
      const withComma = '{"steps": [], "reasoning": "test", "confidence": 0.8, "dependencies": [], "estimatedTimeMs": 1000,}';
    ...
    it('should handle single quotes (convert to double)', () => {
      const singleQuotes = "{'steps': [], 'reasoning': 'test', 'confidence': 0.8, 'dependencies': [], 'estimatedTimeMs': 1000}";
