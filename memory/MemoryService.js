...
class MemoryService {
    ...
    async addMemory(content, type, metadata) {
        ...
        if (this.embeddings.isAvailable()) {
            ...
            embedding = embeddingResult === null || embeddingResult === void 0 ? void 0 : embeddingResult.embedding;
        }
    ...
    async updateMemory(id, updates) {
        ...
        if (contentChanged) {
            if (canEmbed) {
                ...
                if (embeddingResult === null || embeddingResult === void 0 ? void 0 : embeddingResult.embedding) {
                    updates = {
                        ...updates,
    ...
    async addMemoriesBatch(memories) {
        ...
        if (this.embeddings.isAvailable()) {
            ...
            for (let i = 0; i < memories.length; i++) {
                ...
                const embedding = (_a = embeddings[i]) === null || _a === void 0 ? void 0 : _a.embedding;
