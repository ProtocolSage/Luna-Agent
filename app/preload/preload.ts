...
export interface ElectronAPI {
  ...
  // Notifications
  notifications: {
    show: (options: { title: string; body: string; [key: string]: any }) => Promise<void>;
  };
...
const electronAPI: ElectronAPI = {
  ...
  notifications: {
    show: async (options: { title: string; body: string; [key: string]: any }) => {
      logger.info('Notification show requested', 'preload', { title: options.title });
      const sanitizedOptions = sanitizeInput(options);
