...
console.log(
  ...
  Module.builtinModules ? Module.builtinModules.slice(0, 5) : "not available",
);

// Check if electron is a builtin
console.log(
  "[Test] Is electron builtin?",
  Module.builtinModules && Module.builtinModules.includes("electron"),
);
